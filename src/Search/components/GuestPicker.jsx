  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <button className="counter-btn" onClick={onPlus}>
          +
        </button>
      </div>
    </div>
...
export default function GuestPicker({ onClose }) {
  const {
    adults,
    children,
    childrenAges,
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: 24,
            borderRadius: 12,
            background: withPets ? "var(--booking-blue)" : "#ccc",
            position: "relative",
            cursor: "pointer",
      ...
      {!withPets && (
        ...
        >
          ...
          >
            Подробнее о путешествиях с животными-помощниками
          </a>
        </div>
      )}
