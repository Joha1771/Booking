...
const SECTIONS = [
  {
    ...
    items: [
      {
        icon: Wallet,
        label: "Вознаграждения и Кошелёк",
        path: "/profile/wallet",
      },
...
export default function ProfilePage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f5f5f5" }}>
      <Header />
      <div
        style={{ maxWidth: 1000, margin: "0 auto", padding: "32px 16px 48px" }}
      >
        <div
          style={{
            display: "flex",
        ...
        >
          <div style={{ fontSize: 16, fontWeight: 700, marginBottom: 4 }}>
            Ваши Genius-вознаграждения
          </div>
          <div style={{ fontSize: 13, opacity: 0.85, marginBottom: 16 }}>
            Вас ждут вознаграждения и скидки по всему миру.
          </div>
