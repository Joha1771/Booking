...
// Real data from booking.com Apollo cache
...
// Inline SVG icons matching booking.com style
    ...
    <section style={{ padding: "16px 0 32px" }}>
      <div style={{ maxWidth: 1150, margin: "0 auto", padding: "0 16px" }}>
        ...
        <div className="genius-shell">
          {/* All cards in one scrollable row */}
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: 14, lineHeight: 1.5 }}>
                    Joha, ваш статус в нашей программе лояльности —{" "}
                    <strong>Genius 1-го уровня</strong>
                  </div>
                </div>
                    ...
                    {[1, 2, 3].map((level) => (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: 2,
                          background:
                            level === 1 ? "#febb02" : "rgba(255,255,255,0.3)",
                        }}
                      />
                    ))}
                  </div>
              ...
              {GENIUS_BENEFITS.map((b, i) => (
                <div
                  ...
                  style={{
                    ...
                    position: "relative",
                    background: b.locked ? "#fafafa" : "#fff",
                    opacity: b.locked ? 0.85 : 1,
                  }}
                  onMouseEnter={(e) =>
                    !b.locked &&
