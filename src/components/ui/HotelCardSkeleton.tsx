export default function HotelCardSkeleton() {
  return (
    <div style={{ background: "#fff", border: "1px solid var(--booking-border)", borderRadius: 8, overflow: "hidden" }}>
      <div style={{ paddingTop: "65%", background: "linear-gradient(90deg, #f0f0f0 25%, #e0e0e0 50%, #f0f0f0 75%)", backgroundSize: "200% 100%", animation: "shimmer 1.5s infinite" }} />
